        ...
        <section class="module-wrapper-container">
          <section class="tree-module-wrapper-container" v-loading="treeLoading">
            ...
            <section style="margin-top: 1rem">
              <self-tree :jsonData="UnFunResourcesJsonTree" :treeProps="treeProps" @nodeClick="handleNodeClick"
                  ...
                  <el-col :span="8">
                    <el-form-item :label="$t('Resource.table.cssName')">
                      <el-input v-model="formObject.cssName" type="text"
                                :placeholder="$t('Resource.placeholder.cssName')" style="width: 100%"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item :label="$t('Resource.table.display')">
                      <el-checkbox v-model="formObject.isDisplay" style="width: 100%">
    ...
    methods: {
      handleSave (formName) {
        ...
        _that.$refs[formName].validate((valid) => {
          if (valid) {
            _that.formObject.parentName = _that.formParentText

            _that.$post(_that.requestUri, _that.formObject)
              .then(() => {
                _that.$emit('saveRefresh', true)
